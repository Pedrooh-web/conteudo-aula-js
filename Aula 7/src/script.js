...
let frase = 'Eu amo carros. Carro são muito legais. Carros de corrida me encantam.';
...
let exemplo = "Porf avor localize onde 'localize' ocorre.";
...
let exEndsWith = nome.endsWith('Henrique');
